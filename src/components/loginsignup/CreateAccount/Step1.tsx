import { Flex, Input, Stack, Select, Button,Text, Alert, AlertIcon } from '@chakra-ui/react';
    ...
    return (
            ...
            <Input 
                ...
                <Stack direction='column' width='100%' mt={3}>
                    <Text fontWeight={600} color='brand.700' fontSize='15px'>Date of birth</Text>
                ...
                <Button mt={4} width='100%' bg='brand.100'  mb={4} borderColor='brand.100'  borderRadius='full' onClick={handleSubmit}>
                    <Text mr={4}>Next</Text>
                </Button>
            </>  
    )
